...
function ProductDptI() {
  return (
    <ProductLayout>
      <div className="contetns prd four">

        <div className="responsive title_area">
          <h2 data-aos="fade-left">DPT-i</h2>
          <p data-aos="fade-up" data-aos-delay="200">사내 지급(대여, 출장)노트북을 위한 통합 관리 솔루션,<span className="br"></span>이력관리, 매체제어, 보안, 관리 효율성까지 한번에 DPT-i(Intelligent Notebook Security)</p>
        </div>
          ...
          <div className="responsive">
            <div className="wrap">
              <div className="img" data-aos="fade-right">
                <img src={product4Bg1Img} alt="" />
              </div>
              <div className="txt">
                <div className="t-logo" data-aos="fade-left">
                  <span className="white">Intelligent Notebook Security,</span><br /><span className="green">DPT-i</span>
                </div>
                <p data-aos="fade-up">
                  DPT-i (Intelligent Notebook Security Solution)는<span className="br"></span>
                  노트북의 무단 반출을 통제하고 승인된 반출절차를 통해<span className="br"></span>
                  사내 노트북의 보안 통제 관리 솔루션입니다.<span className="br"></span><br />
                  사내 공용 노트북, 업무용 노트북 출장의 통합 보안 관리와<span className="br"></span>
                  주변장치 제어 및 통제, 파일 분석 및 백업 등을 통해 사내<span className="br"></span>
                  기밀자료 정보 유출을 대비할 수 있고, 복귀 시점 복원 및<span className="br"></span>
                  변화된 파일 분석과 초기화 등의 절차로 운용의 편리성을<span className="br"></span>
                  동시에 추구합니다.
                </p>
              </div>
            </div>
